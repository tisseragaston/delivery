...
const mostrarInfo = formulario.addEventListener ("submit", function (e) {
    ...
    <div class="alert alert-info" role="alert">
    <h4> Muchas gracias ${nombreInput.value} por enviarnos tu información. Te vamos a llamar al numero ${telefonoInput.value} para coordinar el envío de tu pedido.</h4>
  </div> `
    Swal.fire({
    icon: 'success',
